//! CERTORA: this file is used to override the error module for Certora verification.
//!     - Unboxes the Error enum to reduce heap usage.
//!     - Reduces reporting on error messages.
//! 
